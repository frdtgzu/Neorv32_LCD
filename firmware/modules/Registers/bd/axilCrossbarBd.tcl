...
################################################################
# This is a generated script based on design: axilCrossbarBd
#
...
# source axilCrossbarBd_script.tcl
...
set design_name axilCrossbarBd
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M00_AXI_0:S00_AXI_0:S01_AXI_0} \
 ] $aclk_0
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S01_AXI_0] [get_bd_addr_segs M00_AXI_0/Reg] -force
